...
type Category = 'members' | 'comms' | 'website' | 'store' | 'team' | 'plans' | 'settings';
...
// Insights stats — the KPI grid, conversions-by-source and lifecycle
// tiles. Driven by the Members tab's shared date range (passed in), so the
// same picker filters these and the attendance summary together.
function InsightsStats({
  ...
  const summary = useQuery({
    queryKey: ['insights-summary', membership?.gymId, start, end],
