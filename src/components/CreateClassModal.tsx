      ...
      <View className="gap-5">
        <ConfirmRow label="Type">
          <View className="flex-row items-center gap-2">
            ...
            <Text className="text-ink dark:text-ink-dk text-base font-medium">
        ...
        {recurring ? (
          <ConfirmRow label="Repeats">
            ...
            <Text className="text-ink-2 dark:text-ink-2-dk text-sm mt-1">
              Starting {dateLabel}
              {indefinite
                ? ''
        ...
        {notes.trim() ? (
          <ConfirmRow label="Notes">
            <Text className="text-ink dark:text-ink-dk">{notes.trim()}</Text>
          </ConfirmRow>
        ) : null}
      </View>
    </ScrollView>
